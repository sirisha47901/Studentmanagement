    ...
    <div class="form">
        ...
        <div class="row">
            <div class="col-md-4 mt-md-0 mt-3">
                ...
                <input type="date" class="form-control" name="dob"  value="<?php echo"{$rows['d_o_b']}"; ?>" required>
            </div>
            <div class="col-md-4 mt-md-0 mt-3">
                <label>Gender</label>
            ...
            <div class="col-md-4 mt-md-0 mt-3">
                <label>Fees</label>
                <input type="number" class="form-control" name="fees"  value="<?php echo"{$rows['fees']}"; ?>" required>
            </div>
        </div>
        <div class="row">
            <div class="col-md-6 mt-md-0 mt-3">
